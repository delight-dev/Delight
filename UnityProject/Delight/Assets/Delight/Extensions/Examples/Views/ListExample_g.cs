    ...
    public partial class ListExample : UIView
    {
            ...
            base(parent, layoutParent, id, template ?? ListExampleTemplates.Default, deferInitialization)
        {
            ...
            List1.ContentTemplates.Add(new ContentTemplate(tiPlayer => 
            {
                ...
                listItem1StateAnimation2.Add(new Animator<System.Boolean>(listItem1, 0.35f, 0f, false, false, 0f, false, EasingFunctions.Get("FlipEnd"), Delight.BoolValueConverter.Interpolator, x => listItem1.IsVisible = x, () => listItem1.IsVisible, () => ListItem.IsVisibleProperty.NotifyPropertyChanged(listItem1), ListItem.IsVisibleProperty, DefaultStateName, "Removed"));
                listItem1StateAnimation2.Add(new Animator<Delight.RaycastBlockMode>(listItem1, 0.35f, 0f, false, false, 0f, false, EasingFunctions.Get("FlipStart"), Delight.EnumValueConverter<Delight.RaycastBlockMode>.Interpolator, x => listItem1.RaycastBlockMode = x, () => listItem1.RaycastBlockMode, () => ListItem.RaycastBlockModeProperty.NotifyPropertyChanged(listItem1), ListItem.RaycastBlockModeProperty, DefaultStateName, "Removed"));
        ...
        public static Template ListExampleListItem1
        {
            get
            {
...
#endif
                {
                    ...
                    Delight.ListItem.OffsetProperty.SetStateDefault("Unlisted", _listExampleListItem1, new ElementMargin(new ElementSize(0.5f, ElementSizeUnit.Percents), new ElementSize(0f, ElementSizeUnit.Percents), new ElementSize(0f, ElementSizeUnit.Percents), new ElementSize(0f, ElementSizeUnit.Percents)));
