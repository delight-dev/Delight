    ...
    public partial class ListExample : UIView
    {
            ...
            base(parent, layoutParent, id, template ?? ListExampleTemplates.Default, deferInitialization)
        {
            ...
            List1.ContentTemplates.Add(new ContentTemplate(tiPlayer => 
            {
                ...
                listItem1StateAnimation2.Add(new Animator<Delight.ElementMargin>(listItem1, 2.85f, 0f, false, false, 0f, false, EasingFunctions.Get("ElasticEaseOut"), Delight.ElementMarginValueConverter.Interpolator, x => listItem1.Offset = x, () => listItem1.Offset, () => ListItem.OffsetProperty.NotifyPropertyChanged(listItem1), ListItem.OffsetProperty, DefaultStateName, "Unlisted"));
                listItem1StateAnimation2.Add(new Animator<UnityEngine.Vector3>(listItem1, 2.85f, 0f, false, false, 0f, false, EasingFunctions.Get("ElasticEaseOut"), Delight.Vector3ValueConverter.Interpolator, x => listItem1.Scale = x, () => listItem1.Scale, () => ListItem.ScaleProperty.NotifyPropertyChanged(listItem1), ListItem.ScaleProperty, DefaultStateName, "Unlisted"));
                listItem1StateAnimation2.Add(new Animator<System.Boolean>(listItem1, 2.85f, 0f, false, false, 0f, false, EasingFunctions.Get("FlipEnd"), Delight.BoolValueConverter.Interpolator, x => listItem1.IsVisible = x, () => listItem1.IsVisible, () => ListItem.IsVisibleProperty.NotifyPropertyChanged(listItem1), ListItem.IsVisibleProperty, DefaultStateName, "Unlisted"));
                listItem1StateAnimation2.Add(new Animator<Delight.RaycastBlockMode>(listItem1, 2.85f, 0f, false, false, 0f, false, EasingFunctions.Get("FlipStart"), Delight.EnumValueConverter<Delight.RaycastBlockMode>.Interpolator, x => listItem1.RaycastBlockMode = x, () => listItem1.RaycastBlockMode, () => ListItem.RaycastBlockModeProperty.NotifyPropertyChanged(listItem1), ListItem.RaycastBlockModeProperty, DefaultStateName, "Unlisted"));
