...
namespace Delight
{
    public partial class ComboBoxExample : LayoutRoot
    {
        ...
        public ComboBoxExample(View parent, View layoutParent = null, string id = null, Template template = null, bool deferInitialization = false) :
            base(parent, layoutParent, id, template ?? ComboBoxExampleTemplates.Default, deferInitialization)
        {
