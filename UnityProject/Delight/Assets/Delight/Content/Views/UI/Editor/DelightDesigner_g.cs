...
namespace Delight
{
    public partial class DelightDesigner : LayoutRoot
    {
            ...
            base(parent, layoutParent, id, template ?? DelightDesignerTemplates.Default, deferInitialization)
        {
            ...
            MainGrid = new LayoutGrid(this, ViewsDesigner.Content, "MainGrid", MainGridTemplate);
            Region1 = new Region(this, MainGrid.Content, "Region1", Region1Template);
            MainGrid.Cell.SetValue(Region1, new CellIndex(0, 0));
            MainGrid.CellSpan.SetValue(Region1, new CellIndex(2, 1));
            ContentExplorer = new Region(this, MainGrid.Content, "ContentExplorer", ContentExplorerTemplate);
            MainGrid.Cell.SetValue(ContentExplorer, new CellIndex(0, 1));
            MainGrid.CellSpan.SetValue(ContentExplorer, new CellIndex(2, 1));
            ...
            XmlEditorRegion = new Region(this, MainGrid.Content, "XmlEditorRegion", XmlEditorRegionTemplate);
            MainGrid.Cell.SetValue(XmlEditorRegion, new CellIndex(1, 2));
            ...
            DisplayRegion = new Region(this, MainGrid.Content, "DisplayRegion", DisplayRegionTemplate);
            ...
            Group2 = new Group(this, DisplayRegion.Content, "Group2", Group2Template);
            Label4 = new Label(this, Group2.Content, "Label4", Label4Template);

            // binding <Label Text="{DisplayedView.Name}">
            Bindings.Add(new Binding(new List<BindingPath> { new BindingPath(new List<string> { "DisplayedView", "Name" }, new List<Func<object>> { () => this, () => DisplayedView }) }, new BindingPath(new List<string> { "Label4", "Text" }, new List<Func<object>> { () => this, () => Label4 }), () => Label4.Text = DisplayedView.Name, () => { }, false));

            // binding <Label IsActive="{LockDisplayButton.ToggleValue}">
            Bindings.Add(new Binding(new List<BindingPath> { new BindingPath(new List<string> { "LockDisplayButton", "ToggleValue" }, new List<Func<object>> { () => this, () => LockDisplayButton }) }, new BindingPath(new List<string> { "Label4", "IsActive" }, new List<Func<object>> { () => this, () => Label4 }), () => Label4.IsActive = LockDisplayButton.ToggleValue, () => { }, false));
            LockDisplayButton = new Button(this, Group2.Content, "LockDisplayButton", LockDisplayButtonTemplate);
            LockDisplayButton.ToggleClick.RegisterHandler(this, "ToggleViewLock");
            HideUI = new Button(this, Group2.Content, "HideUI", HideUITemplate);
            HideUI.ToggleClick.RegisterHandler(this, "ToggleHideUI");
            GridSplitter1 = new GridSplitter(this, MainGrid.Content, "GridSplitter1", GridSplitter1Template);
            MainGrid.Cell.SetValue(GridSplitter1, new CellIndex(0, 2));
            GridSplitter2 = new GridSplitter(this, MainGrid.Content, "GridSplitter2", GridSplitter2Template);
            SaveChangesPopup = new Region(this, ViewsDesigner.Content, "SaveChangesPopup", SaveChangesPopupTemplate);
            Label5 = new Label(this, SaveChangesPopup.Content, "Label5", Label5Template);
        ...
        static DelightDesigner()
        {
            ...
            dependencyProperties.Add(DisplayedViewProperty);
            dependencyProperties.Add(EditedViewProperty);
            dependencyProperties.Add(ViewsDesignerProperty);
            dependencyProperties.Add(ViewsDesignerTemplateProperty);
            dependencyProperties.Add(MainGridProperty);
            dependencyProperties.Add(MainGridTemplateProperty);
            ...
            dependencyProperties.Add(LockDisplayButtonProperty);
            dependencyProperties.Add(LockDisplayButtonTemplateProperty);
            dependencyProperties.Add(HideUIProperty);
            dependencyProperties.Add(HideUITemplateProperty);
        ...
        public readonly static DependencyProperty<Delight.Editor.Parser.DesignerView> DisplayedViewProperty = new DependencyProperty<Delight.Editor.Parser.DesignerView>("DisplayedView");
        public Delight.Editor.Parser.DesignerView DisplayedView
        {
            get { return DisplayedViewProperty.GetValue(this); }
            set { DisplayedViewProperty.SetValue(this, value); }
        }

        public readonly static DependencyProperty<Delight.Editor.Parser.DesignerView> EditedViewProperty = new DependencyProperty<Delight.Editor.Parser.DesignerView>("EditedView");
        public Delight.Editor.Parser.DesignerView EditedView
        {
            get { return EditedViewProperty.GetValue(this); }
            set { EditedViewProperty.SetValue(this, value); }
        }
        ...
        public readonly static DependencyProperty<LayoutGrid> MainGridProperty = new DependencyProperty<LayoutGrid>("MainGrid");
        public LayoutGrid MainGrid
        {
            get { return MainGridProperty.GetValue(this); }
            set { MainGridProperty.SetValue(this, value); }
        }

        public readonly static DependencyProperty<Template> MainGridTemplateProperty = new DependencyProperty<Template>("MainGridTemplate");
        public Template MainGridTemplate
        {
            get { return MainGridTemplateProperty.GetValue(this); }
            set { MainGridTemplateProperty.SetValue(this, value); }
        }
        ...
        public readonly static DependencyProperty<Button> LockDisplayButtonProperty = new DependencyProperty<Button>("LockDisplayButton");
        public Button LockDisplayButton
        {
            get { return LockDisplayButtonProperty.GetValue(this); }
            set { LockDisplayButtonProperty.SetValue(this, value); }
        }

        public readonly static DependencyProperty<Template> LockDisplayButtonTemplateProperty = new DependencyProperty<Template>("LockDisplayButtonTemplate");
        public Template LockDisplayButtonTemplate
        {
            get { return LockDisplayButtonTemplateProperty.GetValue(this); }
            set { LockDisplayButtonTemplateProperty.SetValue(this, value); }
        }

        public readonly static DependencyProperty<Button> HideUIProperty = new DependencyProperty<Button>("HideUI");
        public Button HideUI
        {
            get { return HideUIProperty.GetValue(this); }
            set { HideUIProperty.SetValue(this, value); }
        }

        public readonly static DependencyProperty<Template> HideUITemplateProperty = new DependencyProperty<Template>("HideUITemplate");
        public Template HideUITemplate
        {
            get { return HideUITemplateProperty.GetValue(this); }
            set { HideUITemplateProperty.SetValue(this, value); }
        }
    ...
    public static class DelightDesignerTemplates
    {
        ...
        public static Template DelightDesigner
        {
            get
            {
...
#endif
                {
                    ...
                    Delight.DelightDesigner.MainGridTemplateProperty.SetDefault(_delightDesigner, DelightDesignerMainGrid);
                    ...
                    Delight.DelightDesigner.LockDisplayButtonTemplateProperty.SetDefault(_delightDesigner, DelightDesignerLockDisplayButton);
                    Delight.DelightDesigner.HideUITemplateProperty.SetDefault(_delightDesigner, DelightDesignerHideUI);
                    ...
                    Delight.DelightDesigner.Label6TemplateProperty.SetDefault(_delightDesigner, DelightDesignerLabel6);
                    Delight.DelightDesigner.Group3TemplateProperty.SetDefault(_delightDesigner, DelightDesignerGroup3);
        ...
        public static Template DelightDesignerViewsDesigner
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewsDesigner.LineNumber = 10;
        ...
        private static Template _delightDesignerMainGrid;
        public static Template DelightDesignerMainGrid
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerMainGrid == null || _delightDesignerMainGrid.CurrentVersion != Template.Version)
#else
                if (_delightDesignerMainGrid == null)
#endif
                {
                    _delightDesignerMainGrid = new Template(LayoutGridTemplates.LayoutGrid);
#if UNITY_EDITOR
                    _delightDesignerMainGrid.Name = "DelightDesignerMainGrid";
                    _delightDesignerMainGrid.LineNumber = 11;
                    _delightDesignerMainGrid.LinePosition = 6;
#endif
                    Delight.LayoutGrid.ColumnsProperty.SetDefault(_delightDesignerMainGrid, new ColumnDefinitions { new ColumnDefinition(new ElementSize(40f, ElementSizeUnit.Pixels), 50f, 50f), new ColumnDefinition(new ElementSize(200f, ElementSizeUnit.Pixels)), new ColumnDefinition(new ElementSize(1f, ElementSizeUnit.Proportional))});
                    Delight.LayoutGrid.RowsProperty.SetDefault(_delightDesignerMainGrid, new RowDefinitions { new RowDefinition(new ElementSize(1f, ElementSizeUnit.Proportional)), new RowDefinition(new ElementSize(240f, ElementSizeUnit.Pixels), 20f)});
                }
                return _delightDesignerMainGrid;
            }
        }
        ...
        public static Template DelightDesignerRegion1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerRegion1.LineNumber = 14;
        ...
        public static Template DelightDesignerContentExplorer
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorer.LineNumber = 18;
        ...
        public static Template DelightDesignerRegion2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerRegion2.LineNumber = 21;
        ...
        public static Template DelightDesignerContentExplorerScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegion.LineNumber = 23;
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerContentExplorerScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerContentExplorerScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerContentExplorerScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerContentExplorerScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
        ...
        public static Template DelightDesignerExpander1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerExpander1.LineNumber = 27;
        ...
        public static Template DelightDesignerDefaultExpanderHeader1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDefaultExpanderHeader1.LineNumber = 28;
        ...
        public static Template DelightDesignerDefaultExpanderHeader1HeaderGroup
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDefaultExpanderHeader1HeaderGroup.LineNumber = 3;
                    _delightDesignerDefaultExpanderHeader1HeaderGroup.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerDefaultExpanderHeader1HeaderIcon
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDefaultExpanderHeader1HeaderIcon.LineNumber = 4;
                    _delightDesignerDefaultExpanderHeader1HeaderIcon.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerDefaultExpanderHeader1HeaderLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDefaultExpanderHeader1HeaderLabel.LineNumber = 5;
                    _delightDesignerDefaultExpanderHeader1HeaderLabel.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerExpanderContent1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerExpanderContent1.LineNumber = 29;
        ...
        public static Template DelightDesignerList1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1.LineNumber = 30;
        ...
        public static Template DelightDesignerList1ScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegion.LineNumber = 29;
        ...
        public static Template DelightDesignerList1ScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerList1ScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList1ScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerList1ScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerList1ScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerList1ScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList1ScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerList1ScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerList1ScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerList1ScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerList1ScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerList1ScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList1ScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList1ScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerList1ScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerListItem1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerListItem1.LineNumber = 32;
                    ...
                    Delight.ListItem.HeightProperty.SetDefault(_delightDesignerListItem1, new ElementSize(21f, ElementSizeUnit.Pixels));
                }
        ...
        public static Template DelightDesignerLabel1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLabel1.LineNumber = 33;
        ...
        public static Template DelightDesignerImage1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerImage1.LineNumber = 35;
                    _delightDesignerImage1.LinePosition = 22;
#endif
                    Delight.Image.SpriteProperty.SetDefault(_delightDesignerImage1, Assets.Sprites["eye16"]);
                    Delight.Image.AlignmentProperty.SetDefault(_delightDesignerImage1, Delight.ElementAlignment.Right);
                    Delight.Image.OffsetProperty.SetDefault(_delightDesignerImage1, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(5f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
                    Delight.Image.ColorProperty.SetDefault(_delightDesignerImage1, new UnityEngine.Color(0.5019608f, 0.5019608f, 0.5019608f, 1f));
                    Delight.Image.IsActiveProperty.SetHasBinding(_delightDesignerImage1);
                }
        ...
        public static Template DelightDesignerViewMenu
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenu.LineNumber = 45;
        ...
        public static Template DelightDesignerViewMenuComboBoxButton
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxButton.LineNumber = 10;
                    _delightDesignerViewMenuComboBoxButton.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerViewMenuComboBoxButtonLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxButtonLabel.LineNumber = 15;
                    _delightDesignerViewMenuComboBoxButtonLabel.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxListCanvas
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListCanvas.LineNumber = 11;
                    _delightDesignerViewMenuComboBoxListCanvas.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxList
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxList.LineNumber = 12;
                    _delightDesignerViewMenuComboBoxList.LinePosition = 6;
#endif
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegion.LineNumber = 29;
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerViewMenuComboBoxListScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerViewMenuComboBoxListScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerViewMenuComboBoxListScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerComboBoxListItem1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerComboBoxListItem1.LineNumber = 49;
        ...
        public static Template DelightDesignerLabel2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLabel2.LineNumber = 50;
        ...
        public static Template DelightDesignerComboBoxListItem2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerComboBoxListItem2.LineNumber = 52;
        ...
        public static Template DelightDesignerLabel3
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLabel3.LineNumber = 53;
        ...
        public static Template DelightDesignerXmlEditorRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorRegion.LineNumber = 59;
        ...
        public static Template DelightDesignerXmlEditor
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditor.LineNumber = 60;
        ...
        public static Template DelightDesignerXmlEditorScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegion.LineNumber = 5;
                    _delightDesignerXmlEditorScrollableRegion.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerXmlEditorScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerXmlEditorScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerXmlEditorScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorXmlEditRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorXmlEditRegion.LineNumber = 11;
                    _delightDesignerXmlEditorXmlEditRegion.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorXmlTextRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorXmlTextRegion.LineNumber = 13;
                    _delightDesignerXmlEditorXmlTextRegion.LinePosition = 8;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorTextSelection
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorTextSelection.LineNumber = 14;
                    _delightDesignerXmlEditorTextSelection.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorXmlTextLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorXmlTextLabel.LineNumber = 15;
                    _delightDesignerXmlEditorXmlTextLabel.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorCaret
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorCaret.LineNumber = 17;
                    _delightDesignerXmlEditorCaret.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorUICanvas1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorUICanvas1.LineNumber = 20;
                    _delightDesignerXmlEditorUICanvas1.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteBox
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteBox.LineNumber = 23;
                    _delightDesignerXmlEditorAutoCompleteBox.LinePosition = 12;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsList
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsList.LineNumber = 24;
                    _delightDesignerXmlEditorAutoCompleteOptionsList.LinePosition = 14;
#endif
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegion.LineNumber = 29;
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerXmlEditorAutoCompleteOptionsListScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorDefaultOptionItem
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorDefaultOptionItem.LineNumber = 28;
                    _delightDesignerXmlEditorDefaultOptionItem.LinePosition = 16;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorLabel1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorLabel1.LineNumber = 29;
                    _delightDesignerXmlEditorLabel1.LinePosition = 18;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorAssetOptionItem
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorAssetOptionItem.LineNumber = 32;
                    _delightDesignerXmlEditorAssetOptionItem.LinePosition = 16;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorRawImage1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorRawImage1.LineNumber = 33;
                    _delightDesignerXmlEditorRawImage1.LinePosition = 18;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorLabel2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorLabel2.LineNumber = 34;
                    _delightDesignerXmlEditorLabel2.LinePosition = 18;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorTooltipBox
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorTooltipBox.LineNumber = 41;
                    _delightDesignerXmlEditorTooltipBox.LinePosition = 12;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorTooltipLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorTooltipLabel.LineNumber = 42;
                    _delightDesignerXmlEditorTooltipLabel.LinePosition = 14;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorImage1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorImage1.LineNumber = 44;
                    _delightDesignerXmlEditorImage1.LinePosition = 14;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorXmlEditLeftMargin
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorXmlEditLeftMargin.LineNumber = 51;
                    _delightDesignerXmlEditorXmlEditLeftMargin.LinePosition = 8;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorLineNumbersLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorLineNumbersLabel.LineNumber = 52;
                    _delightDesignerXmlEditorLineNumbersLabel.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorLineNumbersRightBorder
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorLineNumbersRightBorder.LineNumber = 54;
                    _delightDesignerXmlEditorLineNumbersRightBorder.LinePosition = 10;
#endif
                }
        ...
        public static Template DelightDesignerXmlEditorDebugTextLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorDebugTextLabel.LineNumber = 61;
                    _delightDesignerXmlEditorDebugTextLabel.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerLockIcon
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLockIcon.LineNumber = 61;
        ...
        public static Template DelightDesignerXmlEditorStatusBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerXmlEditorStatusBar.LineNumber = 62;
        ...
        public static Template DelightDesignerGroup1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerGroup1.LineNumber = 63;
        ...
        public static Template DelightDesignerAutoParseCheckBox
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerAutoParseCheckBox.LineNumber = 64;
        ...
        public static Template DelightDesignerAutoParseCheckBoxCheckBoxGroup
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerAutoParseCheckBoxCheckBoxGroup.LineNumber = 9;
                    _delightDesignerAutoParseCheckBoxCheckBoxGroup.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerAutoParseCheckBoxCheckBoxImageView
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerAutoParseCheckBoxCheckBoxImageView.LineNumber = 10;
                    _delightDesignerAutoParseCheckBoxCheckBoxImageView.LinePosition = 6;
#endif
        ...
        public static Template DelightDesignerAutoParseCheckBoxCheckBoxLabel
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerAutoParseCheckBoxCheckBoxLabel.LineNumber = 11;
                    _delightDesignerAutoParseCheckBoxCheckBoxLabel.LinePosition = 6;
#endif
        ...
        public static Template DelightDesignerButton1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton1.LineNumber = 65;
                    _delightDesignerButton1.LinePosition = 14;
#endif
        ...
        public static Template DelightDesignerButton1Label
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton1Label.LineNumber = 15;
                    _delightDesignerButton1Label.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerDisplayRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDisplayRegion.LineNumber = 71;
                    _delightDesignerDisplayRegion.LinePosition = 8;
#endif
                    Delight.Region.IsVisibleProperty.SetDefault(_delightDesignerDisplayRegion, false);
                    Delight.Region.BackgroundColorProperty.SetDefault(_delightDesignerDisplayRegion, new UnityEngine.Color(0.2235294f, 0.2705882f, 0.3215686f, 1f));
                }
        ...
        public static Template DelightDesignerScrollableContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegion.LineNumber = 72;
                    ...
                    Delight.ScrollableRegion.MarginProperty.SetDefault(_delightDesignerScrollableContentRegion, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
        ...
        public static Template DelightDesignerScrollableContentRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionContentRegion.LineNumber = 24;
                    _delightDesignerScrollableContentRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerScrollableContentRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerScrollableContentRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerScrollableContentRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerScrollableContentRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerScrollableContentRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerScrollableContentRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerScrollableContentRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerScrollableContentRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerScrollableContentRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerScrollableContentRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerScrollableContentRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerScrollableContentRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerScrollableContentRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerContentRegionCanvas
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerContentRegionCanvas.LineNumber = 74;
        ...
        public static Template DelightDesignerViewContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerViewContentRegion.LineNumber = 75;
        ...
        public static Template DelightDesignerDesignerToolbar1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerDesignerToolbar1.LineNumber = 79;
        ...
        public static Template DelightDesignerGroup2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerGroup2.LineNumber = 80;
                    _delightDesignerGroup2.LinePosition = 10;
#endif
                    Delight.Group.OrientationProperty.SetDefault(_delightDesignerGroup2, Delight.ElementOrientation.Horizontal);
                    Delight.Group.AlignmentProperty.SetDefault(_delightDesignerGroup2, Delight.ElementAlignment.TopRight);
                    Delight.Group.OffsetProperty.SetDefault(_delightDesignerGroup2, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(5f, ElementSizeUnit.Pixels), new ElementSize(15f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
                    Delight.Group.SpacingProperty.SetDefault(_delightDesignerGroup2, new ElementSize(10f, ElementSizeUnit.Pixels));
                }
        ...
        public static Template DelightDesignerLabel4
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLabel4.LineNumber = 81;
                    _delightDesignerLabel4.LinePosition = 12;
#endif
                    Delight.Label.AutoSizeProperty.SetDefault(_delightDesignerLabel4, Delight.AutoSize.Default);
                    Delight.Label.FontColorProperty.SetDefault(_delightDesignerLabel4, new UnityEngine.Color(1f, 1f, 1f, 1f));
                    Delight.Label.FontSizeProperty.SetDefault(_delightDesignerLabel4, 12f);
                    Delight.Label.OffsetProperty.SetDefault(_delightDesignerLabel4, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
                    Delight.Label.TextProperty.SetHasBinding(_delightDesignerLabel4);
                    Delight.Label.IsActiveProperty.SetHasBinding(_delightDesignerLabel4);
                }
                return _delightDesignerLabel4;
            }
        }

        private static Template _delightDesignerLockDisplayButton;
        public static Template DelightDesignerLockDisplayButton
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerLockDisplayButton == null || _delightDesignerLockDisplayButton.CurrentVersion != Template.Version)
#else
                if (_delightDesignerLockDisplayButton == null)
#endif
                {
                    _delightDesignerLockDisplayButton = new Template(ButtonTemplates.Button);
#if UNITY_EDITOR
                    _delightDesignerLockDisplayButton.Name = "DelightDesignerLockDisplayButton";
                    _delightDesignerLockDisplayButton.LineNumber = 82;
                    _delightDesignerLockDisplayButton.LinePosition = 12;
#endif
                    Delight.Button.IsToggleButtonProperty.SetDefault(_delightDesignerLockDisplayButton, true);
                    Delight.Button.OffsetProperty.SetDefault(_delightDesignerLockDisplayButton, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(1f, ElementSizeUnit.Pixels)));
                    Delight.Button.IsActiveProperty.SetDefault(_delightDesignerLockDisplayButton, true);
                    Delight.Button.BackgroundSpriteProperty.SetDefault(_delightDesignerLockDisplayButton, Assets.Sprites["eye64"]);
                    Delight.Button.BackgroundColorProperty.SetDefault(_delightDesignerLockDisplayButton, new UnityEngine.Color(1f, 1f, 1f, 0.3137255f));
                    Delight.Button.BackgroundColorProperty.SetStateDefault("Pressed", _delightDesignerLockDisplayButton, new UnityEngine.Color(1f, 1f, 1f, 1f));
                    Delight.Button.WidthProperty.SetDefault(_delightDesignerLockDisplayButton, new ElementSize(28f, ElementSizeUnit.Pixels));
                    Delight.Button.HeightProperty.SetDefault(_delightDesignerLockDisplayButton, new ElementSize(28f, ElementSizeUnit.Pixels));
                    Delight.Button.LabelTemplateProperty.SetDefault(_delightDesignerLockDisplayButton, DelightDesignerLockDisplayButtonLabel);
                }
                return _delightDesignerLockDisplayButton;
            }
        }

        private static Template _delightDesignerLockDisplayButtonLabel;
        public static Template DelightDesignerLockDisplayButtonLabel
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerLockDisplayButtonLabel == null || _delightDesignerLockDisplayButtonLabel.CurrentVersion != Template.Version)
#else
                if (_delightDesignerLockDisplayButtonLabel == null)
#endif
                {
                    _delightDesignerLockDisplayButtonLabel = new Template(ButtonTemplates.ButtonLabel);
#if UNITY_EDITOR
                    _delightDesignerLockDisplayButtonLabel.Name = "DelightDesignerLockDisplayButtonLabel";
                    _delightDesignerLockDisplayButtonLabel.LineNumber = 15;
                    _delightDesignerLockDisplayButtonLabel.LinePosition = 4;
#endif
                }
                return _delightDesignerLockDisplayButtonLabel;
            }
        }

        private static Template _delightDesignerHideUI;
        public static Template DelightDesignerHideUI
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerHideUI == null || _delightDesignerHideUI.CurrentVersion != Template.Version)
#else
                if (_delightDesignerHideUI == null)
#endif
                {
                    _delightDesignerHideUI = new Template(ButtonTemplates.Button);
#if UNITY_EDITOR
                    _delightDesignerHideUI.Name = "DelightDesignerHideUI";
                    _delightDesignerHideUI.LineNumber = 84;
                    _delightDesignerHideUI.LinePosition = 12;
#endif
                    Delight.Button.IsToggleButtonProperty.SetDefault(_delightDesignerHideUI, true);
                    Delight.Button.IsActiveProperty.SetDefault(_delightDesignerHideUI, true);
                    Delight.Button.BackgroundSpriteProperty.SetDefault(_delightDesignerHideUI, Assets.Sprites["fullscreen"]);
                    Delight.Button.BackgroundColorProperty.SetDefault(_delightDesignerHideUI, new UnityEngine.Color(1f, 1f, 1f, 0.3137255f));
                    Delight.Button.BackgroundColorProperty.SetStateDefault("Pressed", _delightDesignerHideUI, new UnityEngine.Color(1f, 1f, 1f, 1f));
                    Delight.Button.WidthProperty.SetDefault(_delightDesignerHideUI, new ElementSize(16f, ElementSizeUnit.Pixels));
                    Delight.Button.HeightProperty.SetDefault(_delightDesignerHideUI, new ElementSize(16f, ElementSizeUnit.Pixels));
                    Delight.Button.LabelTemplateProperty.SetDefault(_delightDesignerHideUI, DelightDesignerHideUILabel);
                }
                return _delightDesignerHideUI;
            }
        }

        private static Template _delightDesignerHideUILabel;
        public static Template DelightDesignerHideUILabel
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerHideUILabel == null || _delightDesignerHideUILabel.CurrentVersion != Template.Version)
#else
                if (_delightDesignerHideUILabel == null)
#endif
                {
                    _delightDesignerHideUILabel = new Template(ButtonTemplates.ButtonLabel);
#if UNITY_EDITOR
                    _delightDesignerHideUILabel.Name = "DelightDesignerHideUILabel";
                    _delightDesignerHideUILabel.LineNumber = 15;
                    _delightDesignerHideUILabel.LinePosition = 4;
#endif
                }
                return _delightDesignerHideUILabel;
            }
        }
        ...
        public static Template DelightDesignerGridSplitter1
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerGridSplitter1.LineNumber = 89;
        ...
        public static Template DelightDesignerGridSplitter2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerGridSplitter2.LineNumber = 90;
        ...
        public static Template DelightDesignerSaveChangesPopup
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerSaveChangesPopup.LineNumber = 94;
        ...
        public static Template DelightDesignerLabel5
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerLabel5.LineNumber = 95;
                    _delightDesignerLabel5.LinePosition = 8;
#endif
                    Delight.Label.TextProperty.SetDefault(_delightDesignerLabel5, "Do you want to save changes to the following items?");
                    ...
                    Delight.Label.AlignmentProperty.SetDefault(_delightDesignerLabel5, Delight.ElementAlignment.TopLeft);
                    Delight.Label.MarginProperty.SetDefault(_delightDesignerLabel5, new ElementMargin(new ElementSize(10f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
                }
        ...
        public static Template DelightDesignerList2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2.LineNumber = 97;
        ...
        public static Template DelightDesignerList2ScrollableRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegion.LineNumber = 29;
        ...
        public static Template DelightDesignerList2ScrollableRegionContentRegion
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionContentRegion.LineNumber = 24;
                    _delightDesignerList2ScrollableRegionContentRegion.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList2ScrollableRegionHorizontalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionHorizontalScrollbar.LineNumber = 26;
                    _delightDesignerList2ScrollableRegionHorizontalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerList2ScrollableRegionHorizontalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionHorizontalScrollbarBar.LineNumber = 7;
                    _delightDesignerList2ScrollableRegionHorizontalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList2ScrollableRegionHorizontalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionHorizontalScrollbarHandle.LineNumber = 8;
                    _delightDesignerList2ScrollableRegionHorizontalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerList2ScrollableRegionVerticalScrollbar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionVerticalScrollbar.LineNumber = 27;
                    _delightDesignerList2ScrollableRegionVerticalScrollbar.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerList2ScrollableRegionVerticalScrollbarBar
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionVerticalScrollbarBar.LineNumber = 7;
                    _delightDesignerList2ScrollableRegionVerticalScrollbarBar.LinePosition = 4;
#endif
                }
        ...
        public static Template DelightDesignerList2ScrollableRegionVerticalScrollbarHandle
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerList2ScrollableRegionVerticalScrollbarHandle.LineNumber = 8;
                    _delightDesignerList2ScrollableRegionVerticalScrollbarHandle.LinePosition = 6;
#endif
                }
        ...
        public static Template DelightDesignerListItem2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerListItem2.LineNumber = 100;
        ...
        private static Template _delightDesignerLabel6;
        public static Template DelightDesignerLabel6
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerLabel6 == null || _delightDesignerLabel6.CurrentVersion != Template.Version)
#else
                if (_delightDesignerLabel6 == null)
#endif
                {
                    _delightDesignerLabel6 = new Template(LabelTemplates.Label);
#if UNITY_EDITOR
                    _delightDesignerLabel6.Name = "DelightDesignerLabel6";
                    _delightDesignerLabel6.LineNumber = 101;
                    _delightDesignerLabel6.LinePosition = 12;
#endif
                    Delight.Label.FontSizeProperty.SetDefault(_delightDesignerLabel6, 16f);
                    Delight.Label.FontProperty.SetDefault(_delightDesignerLabel6, Assets.TMP_FontAssets["Segoe UI SDF"]);
                    Delight.Label.HeightProperty.SetDefault(_delightDesignerLabel6, new ElementSize(24f, ElementSizeUnit.Pixels));
                    Delight.Label.FontColorProperty.SetDefault(_delightDesignerLabel6, new UnityEngine.Color(0f, 0f, 0f, 1f));
                    Delight.Label.WidthProperty.SetDefault(_delightDesignerLabel6, new ElementSize(1f, ElementSizeUnit.Percents));
                    Delight.Label.MarginProperty.SetDefault(_delightDesignerLabel6, new ElementMargin(new ElementSize(16f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels)));
                    Delight.Label.EnableWordWrappingProperty.SetDefault(_delightDesignerLabel6, false);
                    Delight.Label.OverflowModeProperty.SetDefault(_delightDesignerLabel6, TMPro.TextOverflowModes.Truncate);
                    Delight.Label.ExtraPaddingProperty.SetDefault(_delightDesignerLabel6, true);
                    Delight.Label.TextProperty.SetHasBinding(_delightDesignerLabel6);
                }
                return _delightDesignerLabel6;
            }
        }

        private static Template _delightDesignerGroup3;
        public static Template DelightDesignerGroup3
        {
            get
            {
#if UNITY_EDITOR
                if (_delightDesignerGroup3 == null || _delightDesignerGroup3.CurrentVersion != Template.Version)
#else
                if (_delightDesignerGroup3 == null)
#endif
                {
                    _delightDesignerGroup3 = new Template(GroupTemplates.Group);
#if UNITY_EDITOR
                    _delightDesignerGroup3.Name = "DelightDesignerGroup3";
                    _delightDesignerGroup3.LineNumber = 105;
                    _delightDesignerGroup3.LinePosition = 8;
#endif
                    Delight.Group.OrientationProperty.SetDefault(_delightDesignerGroup3, Delight.ElementOrientation.Horizontal);
                    Delight.Group.SpacingProperty.SetDefault(_delightDesignerGroup3, new ElementSize(8f, ElementSizeUnit.Pixels));
                    Delight.Group.AlignmentProperty.SetDefault(_delightDesignerGroup3, Delight.ElementAlignment.BottomRight);
                    Delight.Group.OffsetProperty.SetDefault(_delightDesignerGroup3, new ElementMargin(new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(0f, ElementSizeUnit.Pixels), new ElementSize(10f, ElementSizeUnit.Pixels), new ElementSize(10f, ElementSizeUnit.Pixels)));
                }
                return _delightDesignerGroup3;
            }
        }
        ...
        public static Template DelightDesignerButton2
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton2.LineNumber = 106;
                    _delightDesignerButton2.LinePosition = 10;
#endif
        ...
        public static Template DelightDesignerButton2Label
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton2Label.LineNumber = 15;
                    _delightDesignerButton2Label.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerButton3
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton3.LineNumber = 107;
        ...
        public static Template DelightDesignerButton3Label
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton3Label.LineNumber = 15;
                    _delightDesignerButton3Label.LinePosition = 4;
#endif
        ...
        public static Template DelightDesignerButton4
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton4.LineNumber = 108;
        ...
        public static Template DelightDesignerButton4Label
        {
            get
            {
...
#endif
                {
                    ...
                    _delightDesignerButton4Label.LineNumber = 15;
                    _delightDesignerButton4Label.LinePosition = 4;
#endif
