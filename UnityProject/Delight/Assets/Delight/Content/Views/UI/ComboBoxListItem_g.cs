...
namespace Delight
{
    public partial class ComboBoxListItem : ListItem
    {
        ...
        public ComboBoxListItem(View parent, View layoutParent = null, string id = null, Template template = null, bool deferInitialization = false) :
            base(parent, layoutParent, id, template ?? ComboBoxListItemTemplates.Default, deferInitialization)
        {
