...
namespace Delight
{
    public partial class UICanvas : UIView
    {
        ...
        public readonly static DependencyProperty<UnityEngine.Canvas> CanvasProperty = new DependencyProperty<UnityEngine.Canvas>();
        ...
        public readonly static DependencyProperty<UnityEngine.UI.CanvasScaler> CanvasScalerProperty = new DependencyProperty<UnityEngine.UI.CanvasScaler>();
        ...
        public readonly static DependencyProperty<UnityEngine.UI.GraphicRaycaster> GraphicRaycasterProperty = new DependencyProperty<UnityEngine.UI.GraphicRaycaster>();
        ...
        public readonly static MappedDependencyProperty<UnityEngine.RenderMode, UnityEngine.Canvas, UICanvas> RenderModeProperty = new MappedDependencyProperty<UnityEngine.RenderMode, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.renderMode, (x, y) => x.renderMode = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas> ScaleFactorProperty = new MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.scaleFactor, (x, y) => x.scaleFactor = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas> ReferencePixelsPerUnitProperty = new MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.referencePixelsPerUnit, (x, y) => x.referencePixelsPerUnit = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas> OverridePixelPerfectProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.overridePixelPerfect, (x, y) => x.overridePixelPerfect = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas> PixelPerfectProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.pixelPerfect, (x, y) => x.pixelPerfect = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas> PlaneDistanceProperty = new MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.planeDistance, (x, y) => x.planeDistance = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas> OverrideSortingProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.overrideSorting, (x, y) => x.overrideSorting = y);
        ...
        public readonly static MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas> SortingOrderProperty = new MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.sortingOrder, (x, y) => x.sortingOrder = y);
        ...
        public readonly static MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas> TargetDisplayProperty = new MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.targetDisplay, (x, y) => x.targetDisplay = y);
        ...
        public readonly static MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas> SortingLayerIDProperty = new MappedDependencyProperty<System.Int32, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.sortingLayerID, (x, y) => x.sortingLayerID = y);
        ...
        public readonly static MappedDependencyProperty<System.String, UnityEngine.Canvas, UICanvas> SortingLayerNameProperty = new MappedDependencyProperty<System.String, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.sortingLayerName, (x, y) => x.sortingLayerName = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Camera, UnityEngine.Canvas, UICanvas> WorldCameraProperty = new MappedDependencyProperty<UnityEngine.Camera, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.worldCamera, (x, y) => x.worldCamera = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas> NormalizedSortingGridSizeProperty = new MappedDependencyProperty<System.Single, UnityEngine.Canvas, UICanvas>(x => x.Canvas, x => x.normalizedSortingGridSize, (x, y) => x.normalizedSortingGridSize = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.CanvasScaler.ScaleMode, UnityEngine.UI.CanvasScaler, UICanvas> UiScaleModeProperty = new MappedDependencyProperty<UnityEngine.UI.CanvasScaler.ScaleMode, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.uiScaleMode, (x, y) => x.uiScaleMode = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> CanvasScalerReferencePixelsPerUnitProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.referencePixelsPerUnit, (x, y) => x.referencePixelsPerUnit = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> CanvasScalerScaleFactorProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.scaleFactor, (x, y) => x.scaleFactor = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Vector2, UnityEngine.UI.CanvasScaler, UICanvas> ReferenceResolutionProperty = new MappedDependencyProperty<UnityEngine.Vector2, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.referenceResolution, (x, y) => x.referenceResolution = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> MatchWidthOrHeightProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.matchWidthOrHeight, (x, y) => x.matchWidthOrHeight = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.CanvasScaler.Unit, UnityEngine.UI.CanvasScaler, UICanvas> PhysicalUnitProperty = new MappedDependencyProperty<UnityEngine.UI.CanvasScaler.Unit, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.physicalUnit, (x, y) => x.physicalUnit = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> FallbackScreenDPIProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.fallbackScreenDPI, (x, y) => x.fallbackScreenDPI = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> DefaultSpriteDPIProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.defaultSpriteDPI, (x, y) => x.defaultSpriteDPI = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas> DynamicPixelsPerUnitProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.CanvasScaler, UICanvas>(x => x.CanvasScaler, x => x.dynamicPixelsPerUnit, (x, y) => x.dynamicPixelsPerUnit = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.GraphicRaycaster, UICanvas> IgnoreReversedGraphicsProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.GraphicRaycaster, UICanvas>(x => x.GraphicRaycaster, x => x.ignoreReversedGraphics, (x, y) => x.ignoreReversedGraphics = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.GraphicRaycaster.BlockingObjects, UnityEngine.UI.GraphicRaycaster, UICanvas> BlockingObjectsProperty = new MappedDependencyProperty<UnityEngine.UI.GraphicRaycaster.BlockingObjects, UnityEngine.UI.GraphicRaycaster, UICanvas>(x => x.GraphicRaycaster, x => x.blockingObjects, (x, y) => x.blockingObjects = y);
