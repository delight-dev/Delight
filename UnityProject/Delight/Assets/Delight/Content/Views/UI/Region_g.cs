...
namespace Delight
{
    public partial class Region : UIImageView
    {
        ...
        public Region(View parent, View layoutParent = null, string id = null, Template template = null, bool deferInitialization = false) :
            base(parent, layoutParent, id, template ?? RegionTemplates.Default, deferInitialization)
        {
...
#if UNITY_EDITOR
                    _region.Name = "Region";
                    _region.LineNumber = 0;
                    _region.LinePosition = 0;
#endif
