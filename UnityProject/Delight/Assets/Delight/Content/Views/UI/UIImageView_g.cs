...
namespace Delight
{
    public partial class UIImageView : UIView
    {
        ...
        public readonly static DependencyProperty<UnityEngine.UI.Image> ImageProperty = new DependencyProperty<UnityEngine.UI.Image>();
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Sprite, UnityEngine.UI.Image, UIImageView> BackgroundSpriteProperty = new MappedDependencyProperty<UnityEngine.Sprite, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.sprite, (x, y) => x.sprite = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Sprite, UnityEngine.UI.Image, UIImageView> BackgroundOverrideSpriteProperty = new MappedDependencyProperty<UnityEngine.Sprite, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.overrideSprite, (x, y) => x.overrideSprite = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.Image.Type, UnityEngine.UI.Image, UIImageView> BackgroundTypeProperty = new MappedDependencyProperty<UnityEngine.UI.Image.Type, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.type, (x, y) => x.type = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundPreserveAspectProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.preserveAspect, (x, y) => x.preserveAspect = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundFillCenterProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.fillCenter, (x, y) => x.fillCenter = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.UI.Image.FillMethod, UnityEngine.UI.Image, UIImageView> BackgroundFillMethodProperty = new MappedDependencyProperty<UnityEngine.UI.Image.FillMethod, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.fillMethod, (x, y) => x.fillMethod = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.Image, UIImageView> BackgroundFillAmountProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.fillAmount, (x, y) => x.fillAmount = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundFillClockwiseProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.fillClockwise, (x, y) => x.fillClockwise = y);
        ...
        public readonly static MappedDependencyProperty<System.Int32, UnityEngine.UI.Image, UIImageView> BackgroundFillOriginProperty = new MappedDependencyProperty<System.Int32, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.fillOrigin, (x, y) => x.fillOrigin = y);
        ...
        public readonly static MappedDependencyProperty<System.Single, UnityEngine.UI.Image, UIImageView> BackgroundAlphaHitTestMinimumThresholdProperty = new MappedDependencyProperty<System.Single, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.alphaHitTestMinimumThreshold, (x, y) => x.alphaHitTestMinimumThreshold = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundUseSpriteMeshProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.useSpriteMesh, (x, y) => x.useSpriteMesh = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Material, UnityEngine.UI.Image, UIImageView> BackgroundMaterialProperty = new MappedDependencyProperty<UnityEngine.Material, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.material, (x, y) => x.material = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundMaskableProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.maskable, (x, y) => x.maskable = y);
        ...
        public readonly static MappedDependencyProperty<UnityEngine.Color, UnityEngine.UI.Image, UIImageView> BackgroundColorProperty = new MappedDependencyProperty<UnityEngine.Color, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.color, (x, y) => x.color = y);
        ...
        public readonly static MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView> BackgroundRaycastTargetProperty = new MappedDependencyProperty<System.Boolean, UnityEngine.UI.Image, UIImageView>(x => x.Image, x => x.raycastTarget, (x, y) => x.raycastTarget = y);
