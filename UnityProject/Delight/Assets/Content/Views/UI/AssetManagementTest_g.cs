...
namespace Delight
{
    public partial class AssetManagementTest : LayoutRoot
    {
            ...
            base(parent, layoutParent, id, template ?? AssetManagementTestTemplates.Default, initializer)
        {
            ...
            if (LoadAllButton.Click == null) LoadAllButton.Click = new ViewAction();
            LoadAllButton.Click.RegisterHandler(ResolveActionHandler(this, "LoadAll"));
            Load1Button = new Button(this, Group1.Content, "Load1Button", Load1ButtonTemplate);
            if (Load1Button.Click == null) Load1Button.Click = new ViewAction();
            Load1Button.Click.RegisterHandler(ResolveActionHandler(this, "ToggleLoad1"));
            Load2Button = new Button(this, Group1.Content, "Load2Button", Load2ButtonTemplate);
            if (Load2Button.Click == null) Load2Button.Click = new ViewAction();
            Load2Button.Click.RegisterHandler(ResolveActionHandler(this, "ToggleLoad2"));
            Load3Button = new Button(this, Group1.Content, "Load3Button", Load3ButtonTemplate);
            if (Load3Button.Click == null) Load3Button.Click = new ViewAction();
            Load3Button.Click.RegisterHandler(ResolveActionHandler(this, "ToggleLoad3"));
            Load4Button = new Button(this, Group1.Content, "Load4Button", Load4ButtonTemplate);
            if (Load4Button.Click == null) Load4Button.Click = new ViewAction();
            Load4Button.Click.RegisterHandler(ResolveActionHandler(this, "ToggleLoad4"));
            Button1 = new Button(this, Group1.Content, "Button1", Button1Template);
            if (Button1.Click == null) Button1.Click = new ViewAction();
            Button1.Click.RegisterHandler(ResolveActionHandler(this, "UnloadAll"));
            Button2 = new Button(this, Group1.Content, "Button2", Button2Template);
            if (Button2.Click == null) Button2.Click = new ViewAction();
            Button2.Click.RegisterHandler(ResolveActionHandler(this, "SetSprite"));
