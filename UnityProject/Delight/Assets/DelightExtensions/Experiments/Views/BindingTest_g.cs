...
namespace Delight
{
    public partial class BindingTest : UIView
    {
        ...
        public BindingTest(View parent, View layoutParent = null, string id = null, Template template = null, bool deferInitialization = false) :
            base(parent, layoutParent, id, template ?? BindingTestTemplates.Default, deferInitialization)
        {
