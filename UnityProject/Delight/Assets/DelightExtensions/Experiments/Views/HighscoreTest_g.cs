...
namespace Delight
{
    public partial class HighscoreTest : LayoutRoot
    {
        ...
        public HighscoreTest(View parent, View layoutParent = null, string id = null, Template template = null, bool deferInitialization = false) :
            base(parent, layoutParent, id, template ?? HighscoreTestTemplates.Default, deferInitialization)
        {
